...
cols = ['RECORD_NBR','JOB_CLASS_PGRADE', 'PAY_YEAR', 'GENDER', 'ETHNICITY', 'JOB_TITLE', 'JOB_CLASS_PGRADE_RANK', 'PROMOTION']
...
df2['ETHNICITY'] = df2['ETHNICITY'].str.strip().replace(group_ethnicity)
...
promotions['GROUPING_01'] = promotions['JOB_TITLE'].str.strip().replace(grouping_01)
promotions['GROUPING_02'] = promotions['JOB_TITLE'].str.strip().replace(grouping_02)
